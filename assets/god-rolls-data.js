...
window.GodRollsData = (function(){
  const WEAPONS = [
    ...
    { name:"Rufus's Fury", slug:"rufuss-fury",
      itemHash: 484515708,
      perkHashes: [3048246338, 1968098204, 461595545, 102912326, 2600715579],
    ...
    { name:"Chroma Rush", slug:"chroma-rush",
      itemHash: 771811871,
      perkHashes: [3048246338, 3267421167, 4245865861, 1549370717, 261199142, 622249644, 1523545668],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Wendigo GL3", slug:"wendigo-gl3",
      itemHash: 4021098353,
      perkHashes: [373417387, 409713597, 3528046508, 2275087323, 2223800157, 3587454724, 1523545668],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Lotus-Eater", slug:"lotus-eater",
      ...
      raidSlug: null, dungeonSlug: null,
      note: "Energy pick for Perpetual Slam. This is the base S29 version (itemHash 924095500) \u2014 there's also an \\\"Upgraded\\\" craftable variant with a different hash; make sure you're tracking the one you actually run.",
      buildTags: ["perpetual-slam"],
      pairing: null },
