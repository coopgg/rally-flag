  ...
  const BUILDS = [
    {
      ...
      loop: [
        ...
        "Eutechnology isn't the centerpiece, but it's along for the same ride: Gift of the Ley Lines spawns a breach off rapid Void kills, and Techeun's Foresight triggers a detonation off your next Void weapon final blow after grabbing one, and both fire constantly once Turncoat has a room weakened. Served Cold (artifact) turns every one of those breach pickups into melee energy on top.",
