...
window.PuzzleHelperData = (function(){
  const TOOLS = [
    ...
    },
    {
      ...
      referencePoint: "the first enclosed room at the very start of the raid \u2014 columns of Resonance shapes on the wall. Read the third column from the left, bottom to top \u2014 all 5 symbols",
      ...
      positions: [
        ...
        { number: 2, chest: "mod", name: "Mod Room 1", simpleLocation: "Also before the first encounter, near the first red border chest room", detailedLocation: "A short distance from the first red border chest room. When you enter a doorframe and need to jump across a chasm, jump to the stairs on your left instead \u2014 crouch down to find a gap in the wall." },
