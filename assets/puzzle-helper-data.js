...
window.PuzzleHelperData = (function(){
  const TOOLS = [
    ...
    },
    {
      ...
      intro: "Right at the start of Salvation's Edge, before the first encounter, a wall shows columns of Resonance shapes \u2014 the third column from the left is the one that matters. That column shows 5 symbols stacked bottom to top, but only the bottom, middle, and top symbols matter for this chest; the 2nd and 4th symbols are for the raid's separate mod-drop chest, not this one, and it's easy to grab the wrong ones if you're not counting carefully. The three rooms below are real, fixed locations spread through the raid and are always active every run \u2014 no need to check for a glowing plate. Deposit the matching Resonance shape in each one, in order. Get all three right in a single continuous clear and the bonus chest \u2014 a guaranteed red border weapon \u2014 spawns once the Witness is defeated.",
      icons: { C: "puzzle-assets/SE_C.png", S: "puzzle-assets/SE_S.png", T: "puzzle-assets/SE_T.png" },
      positions: [
        { number: 1, name: "Bottom Symbol \u2014 Room 1", simpleLocation: "Very start of the raid, in the first large open room", detailedLocation: "Right when you enter the large open room at the start, jump up a bit and follow the path to the left toward a large, well-lit doorway \u2014 that leads straight into Room 1." },
        { number: 2, name: "Middle Symbol \u2014 Room 3", simpleLocation: "Between the 1st and 2nd encounters", detailedLocation: "Between the first and second encounters. After riding the red elevator up, you'll cross large greenish-blue cubes \u2014 keep an eye on the right-side wall for a large, well-lit gap leading into Room 3." },
        { number: 3, name: "Top Symbol \u2014 Room 5", simpleLocation: "Also before the 3rd encounter", detailedLocation: "Also before the third encounter. In the inner room with the rotting tree branches, jump up and to the left, then keep climbing until you reach the conductor plates \u2014 the last possible room." }
      ]
    },
    {
      slug: "verity-solver",
